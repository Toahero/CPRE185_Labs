...
-----------------------------------------------------------------------------*/
#include <stdio.h>
#include <stdlib.h> //Added inclusion
#include <time.h>

//fixed comment error on prototypes
/*-----------------------------------------------------------------------------
-                                Prototypes                                   -
------------------------------------------------------------------------------*/
...
-								Implementation								 -
-----------------------------------------------------------------------------*/
//fixed implementation header commenting
...
void run_game(int computer_number)
{
    ...
    while (!correct)    /* This line does not contain an error */
    {
        ...
        } //else if (number = computer_number) Error 4
